...
public class ProductVOTest {
    ...
    String product_delivery; // 택배거래(비용) : before = 착불, after = 착불, none = 불가능
    String product_transaction_area; // 거래가능지역 : none = 불가능, 사용자입력값
    
    int product_purchase_price; // 즉시구매가격
    int product_re_auction; // 재경매 : 0 = 불가능, 1 = 가능
    ...
    int  product_progress; // 진행상태 : 진행중 = 0, 낙찰 = 1
