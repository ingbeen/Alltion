...
public class ProductVOTest {
	...
	Date product_end_date; //경매종료일
	int product_starting_price; //경매시작가
	int product_re_auction; //재경매
	int product_purchare_price; //즉시구매가격
	int product_bidding_unit; //입찰단위
	String product_transaction_area; //직거래가능지역
	...
	public int getProduct_purchare_price() {
		return product_purchare_price;
	}
	public void setProduct_purchare_price(int product_purchare_price) {
		this.product_purchare_price = product_purchare_price;
	}
	...
	public String getProduct_progress() {
