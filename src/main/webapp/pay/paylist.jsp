...
<body>
			...
			<div class="chargehistory">
				...
				<div class="pay_list">
					<ul class="firstcharge">
						<li>
							<span class="charge__list title">No</span>
						</li>
						<li>
							<span class="charge__list title">결제주문번호</span>
						</li>
						<li>
							<span class="charge__list title">결제 금액</span>
						</li>
						<li>
							<span class="charge__list title">이전 금액 </span>
						</li>
						<li>
							<span class="charge__list title">변동 후 금액</span>
						</li>
						<li>
							<span class="charge__list title">결제 상태</span>
						</li>
					</ul>
					<%
						if (!chargevo.isEmpty()) {
					...
					<ul class="charge">
						<li>
							<span class="charge__list content"><%=vo.getRnum()%></span>
						</li>
						<li>
							<span class="charge__list content"><%=vo.getPay_merchant_uid()%></span>
						</li>
						<li>
							<span class="charge__list content"><%=vo.getPay_amount()%></span>
						</li>
						<li>
							<span class="charge__list content"><%=vo.getPay_lastmoney()%></span>
						<li>
							<span class="charge__list content"><%=vo.getPay_nowmoney()%></span>
						</li>
						<li>
							<span class="charge__list content">결제</span>
						</li>
					</ul>
					<%
						}
 ...
 %> <a
							href="./goPaylist.ms?page1=<%=nowpage1 - 1%>">&#60;</a> <%
 	}
 %>
						</li>
						<%
						...
						%>
						<li><a href="./goPaylist.ms?page1=<%=a%>"><%=a%></a></li>
						<%
							}
						%>
						<%
			...
			<div class="cancelhistory">
				...
				<div class="pay_list">
					<ul class="firstcancel">
						...
						<li>
							<span class="cancel__list title">결제주문번호</span>
						</li>
						<li>
					...
					<ul class="cancel">
						...
						<li>
							<span class="cancel__list content"><%=vo.getPay_merchant_uid()%></span>
						</li>
						<li>
							<span class="cancel__list content"><%=vo.getPay_amount()%></span>
						</li>
						<li>
							<span class="cancel__list content"><%=vo.getPay_lastmoney()%></span>
						</li>
						<li>
							<span class="cancel__list content"><%=vo.getPay_nowmoney()%></span>
						</li>
						<li>
							<span class="cancel__list content"><%=vo.getPay_status()%></span>
						</li>
					</ul>
					<%
						}
 ...
 %> <a
							href="./goPaylist.ms?page2=<%=nowpage2 - 1%>">&#60;</a> <%
 	}
 %>
						</li>
						<%
						...
						%>
						<li><a href="./goPaylist.ms?page2=<%=a%>" class="num"><%=a%></a>
						</li>
						<%
							}
						%>
 ...
 %> <a
							href="./goPaylist.ms?page3=<%=nowpage3 - 1%>">&#60;</a> <%
 	}
 %>
						</li>
						<%
						...
						%>
						<li><a href="./goPaylist.ms?page3=<%=a%>" class="num"><%=a%></a>
						</li>
						<%
							}
						%>
		...
		<div>
			<form name="test1" action="plus.ms">
				<input type="hidden" name="userId" value="${userId}"> <input
					type="hidden" name="product_subject" value="테스트상품1"> <input
					type="hidden" name="amount" value=10000> <a href=""
					onclick="plusClick();">플러스</a>
			</form>
			<form name="test2" action="minus.ms">
				<input type="hidden" name="userId" value="${userId}"> <input
					type="hidden" name="product_subject" value="테스트상품1"> <input
					type="hidden" name="amount" value=10000> <a href=""
					onclick="minusClick();">마이너스</a>
			</form>
		</div>
	</div>
